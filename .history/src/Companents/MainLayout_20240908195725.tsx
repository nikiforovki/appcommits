...
import {
  ...
  useDeleteReplyMutation, // Импортируем useDeleteReplyMutation
...
const MainLayout: React.FC = () => {
  ...
  const [deleteReply] = useDeleteReplyMutation(); // Используем useDeleteReplyMutation
  ...
  const handleDeleteComment = async (id: string) => {
    try {
      ...
      // Удаляем все ответы, связанные с этим комментарием
