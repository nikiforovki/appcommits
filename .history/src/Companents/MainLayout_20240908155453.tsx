  ...
  const handleReply = async (commentId: string) => {
    if (replyText) {
      try {
        ...
        // Используем mutation для добавления ответа
        const response = await useAddReplyMutation.mutateAsync(replyData, {
          commentId,
        });
        ...
        // Возможно, здесь нужно обновить список комментариев
        // Например, если вы используете SWR для кэширования
